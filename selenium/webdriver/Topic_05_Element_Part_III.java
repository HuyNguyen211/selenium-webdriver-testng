...
public class Topic_05_Element_Part_III {
	...
	public void TC_02_Invalid_EMail() {
		driver.findElement(fullnameTextboxBy).sendKeys("test01");
	...
	public void TC_06_Invalid_Phone() {
		...
		driver.findElement(phoneTextboxBy).sendKeys("09231");
		driver.findElement(registerButtonBy).click();
		...
		driver.findElement(phoneTextboxBy).sendKeys("1234567890");
		driver.findElement(registerButtonBy).click();
